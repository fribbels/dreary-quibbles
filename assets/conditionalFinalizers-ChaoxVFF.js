import{K as a,S as _,n as i}from"./index-uKR0oAWy.js";const N=A=>A.BASIC_ADDITIONAL_DMG.buff(A.a[a.BASIC_ADDITIONAL_DMG_SCALING]*D(A,0),_.NONE),t=A=>A.ULT_ADDITIONAL_DMG.buff(A.a[a.ULT_ADDITIONAL_DMG_SCALING]*D(A,0),_.NONE),O=()=>`x.BASIC_ADDITIONAL_DMG += x.BASIC_ADDITIONAL_DMG_SCALING * (x.ATK + (x.ATK_P_BOOST) * baseATK);
